...
| Item | Commercial term |
|---|---|
| Annual subscription | EUR 18,000 excluding VAT |
| Initial term | 36 months |
| Billing | Annual, payable in advance |
| Included users | Up to 100 named users |
| Included usage | 12 million processing units per contract year |
| Additional usage | EUR 18 per 10,000 processing units |
| Implementation | Included remote onboarding, up to 12 hours |
| Support | Business-hours email support, target first response within one business day |
| Renewal | Automatic 12-month renewal unless either party gives 60 days' notice |
| Price review | Up to 5% at each renewal |

The annual subscription exceeds EUR 15,000. Any internal purchasing or director-approval requirement remains the customer's responsibility and is not waived by acceptance of this proposal.
...
This proposal incorporates the following documents when executed:
...
If documents conflict, the executed order form controls for commercial scope, the Data Processing Addendum controls for personal-data processing, and the Master Subscription Agreement controls for other matters.

## Assumptions and exclusions

- Customer is responsible for user permissions, lawful instructions, and internal review of AI-assisted output.
- The service does not make final legal, employment, credit, medical, or procurement decisions on the customer's behalf.
- Bespoke integrations, on-premises deployment, customer-managed encryption keys, and professional legal review are excluded.
- Data migration beyond the onboarding allowance is separately scoped.
- This proposal does not warrant compliance with any customer-specific policy.
