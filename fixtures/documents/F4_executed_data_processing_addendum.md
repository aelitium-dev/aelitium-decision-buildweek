# F4 — NovaMind AI Data Processing Addendum
...
**Document reference:** NM-DPA-EU-2026-04  
**Form proposed by:** NovaMind AI Ltd.  
**Executed for:** Caldera Works Europe S.A.S.  
**Effective date:** 2026-07-12  
**DPA version:** 4.3

This Data Processing Addendum (the **DPA**) forms part of the Master Subscription Agreement and enterprise order documentation between Caldera Works Europe S.A.S. (**Customer**, **Controller**) and NovaMind AI Ltd. (**NovaMind**, **Processor**) for the NovaMind Workspace Enterprise service.
...
*NM-DPA-EU-2026-04 · Page 1 of 34*
...
*NM-DPA-EU-2026-04 · Page 2 of 34*
...
This DPA governs NovaMind's Processing of Personal Data on Customer's behalf in connection with the Service. It allocates responsibilities for confidentiality, security, assistance, retention, subprocessors, international transfers, and deletion.

### 1.2 Scope

This DPA applies when Customer or an authorized user submits Personal Data to the Service, or when NovaMind otherwise Processes Personal Data to provide, secure, support, or maintain the Service. It does not govern data for which NovaMind independently determines purposes and means and acts as a separate Controller, except where Applicable Data Protection Law requires additional terms.
...
*NM-DPA-EU-2026-04 · Page 3 of 34*
...
**Customer Content** means information submitted to, stored in, or generated for Customer through the Service, excluding NovaMind's own account, billing, and aggregated service-administration data.
...
**Service** means NovaMind Workspace Enterprise and the hosted features identified in the applicable order form.
...
**Subprocessor** means a third party engaged by NovaMind to Process Customer Data on Customer's behalf. A network carrier acting only as a conduit is not a Subprocessor for this definition.

Terms such as “including” are illustrative and not limiting. Singular includes plural where the context permits.

*NM-DPA-EU-2026-04 · Page 4 of 34*
...
Customer is Controller and NovaMind is Processor for Customer Data. Where Customer acts as Processor for another Controller, NovaMind acts as Customer's Subprocessor and Customer represents that its instructions are authorized by the relevant Controller.

### 3.2 Instructions

NovaMind will Process Customer Data only on documented instructions from Customer, including to provide the Service, comply with configured settings, prevent abuse, maintain security, provide support, and perform obligations in the Agreement. The Agreement, authorized use of the Service, support requests, and lawful configuration changes constitute documented instructions.

### 3.3 Legally required Processing

If law requires NovaMind to Process Customer Data beyond Customer's instructions, NovaMind will inform Customer before Processing unless law prohibits notice on important public-interest grounds.

### 3.4 Unlawful instructions

NovaMind will inform Customer if it reasonably believes an instruction infringes Applicable Data Protection Law. NovaMind may suspend the affected Processing while the parties clarify the instruction, without deciding Customer's legal obligations for it.

### 3.5 Customer control

Customer determines which Authorized Users receive access, which documents they submit, what retention settings they select, and whether AI-assisted output is used in a business process. NovaMind does not become the decision maker merely by generating or organizing output.

### 3.6 Purpose limitation

NovaMind will not sell Customer Data or use it for targeted advertising. AI-specific restrictions, including model-training treatment, appear in section 11.

*NM-DPA-EU-2026-04 · Page 5 of 34*
...
NovaMind will implement the measures described in this DPA, make available information reasonably necessary to demonstrate those measures, and cooperate with Customer as required for Customer's documented obligations relating to Customer Data.

### 4.2 Customer obligations

Customer is responsible for the lawfulness, accuracy, quality, and collection of Customer Data; required notices and consents; its instructions; and its Authorized Users. Customer will not direct NovaMind to Process prohibited data categories unless the parties have expressly agreed appropriate controls.

### 4.3 Requests for information

Cooperation is subject to reasonable scope, confidentiality, security, and effort controls. NovaMind may satisfy repeated or broad requests through current audit reports, certifications, security documentation, written responses, or a scoped meeting.

### 4.4 Regulatory cooperation

If a supervisory authority contacts NovaMind directly about Customer Data, NovaMind will notify Customer unless prohibited and will not represent Customer's position without authorization. Customer remains responsible for its regulatory communications.
...
Ordinary assistance included in NovaMind's standard compliance programme is included in subscription fees. NovaMind may charge reasonable pre-agreed fees for bespoke, repetitive, or unusually burdensome assistance not caused by its breach.

*NM-DPA-EU-2026-04 · Page 6 of 34*
...
NovaMind ensures that personnel authorized to Process Customer Data are bound by statutory or contractual confidentiality obligations. Authorization is limited to people who require access for their role.
...
NovaMind will not disclose Customer Data to a third party except to an authorized Subprocessor, as instructed by Customer, or as legally required. Before a lawful disclosure where notice is permitted, NovaMind will provide available information so Customer can seek protective measures.
...
*NM-DPA-EU-2026-04 · Page 7 of 34*
...
NovaMind periodically evaluates threats and control effectiveness. Material findings are assigned owners and target dates. Risk acceptance requires an authorized role.
...
Security depends on Customer configuration and Authorized User behavior as well as NovaMind controls. Customer is responsible for SSO configuration, account lifecycle, role assignment, appropriate source documents, endpoint security, and review of AI-assisted output.

Annex II summarizes controls and is not an exhaustive security architecture disclosure.

*NM-DPA-EU-2026-04 · Page 8 of 34*
...
NovaMind assigns unique workforce identities and prohibits shared privileged accounts except controlled emergency credentials. Multi-factor authentication is required for administrative access to production infrastructure.
...
NovaMind uses centrally managed authentication where feasible, password standards, session controls, and device-security requirements. Service accounts use managed credentials or workload identity where supported.
...
*NM-DPA-EU-2026-04 · Page 9 of 34*
...
Customer Data is encrypted in transit over public networks using TLS 1.2 or later where supported by the communicating system. NovaMind disables obsolete protocols according to its security baseline.
...
*NM-DPA-EU-2026-04 · Page 10 of 34*
...
NovaMind performs vulnerability scanning of relevant infrastructure, applications, containers, and dependencies on a risk-based schedule. Findings are prioritized by severity, exploitability, exposure, and compensating controls.
...
An independent provider performs penetration testing at least annually against material Service surfaces. NovaMind tracks findings and may provide an executive summary subject to confidentiality.
...
Customer may not perform intrusive testing without NovaMind's prior written authorization. A coordinated-testing request must identify scope, timing, source addresses, methods, and contacts. NovaMind may impose safety conditions.

### 6.3.6 Responsible disclosure

NovaMind maintains a channel for security reports and investigates credible submissions. Disclosure terms do not authorize access to other customers' data.

### 6.3.7 Assurance status

As of this DPA's effective date, the parties' questionnaire records NovaMind's SOC 2 Type II examination as in progress. This DPA does not convert an unfinished examination into an issued report.

*NM-DPA-EU-2026-04 · Page 11 of 34*
...
NovaMind maintains an incident-response plan defining preparation, identification, containment, investigation, recovery, communication, and lessons learned. Relevant personnel participate in exercises at least annually.

### 7.2 Triage

Suspected events are triaged according to severity and potential impact. NovaMind may preserve evidence, restrict access, isolate resources, rotate credentials, or suspend affected features during investigation.
...
NovaMind restricts access to incident evidence and retains it according to investigative, contractual, and legal needs. Sharing may be limited to protect other customers, personnel, systems, legal privilege, or active investigations.
...
*NM-DPA-EU-2026-04 · Page 12 of 34*
...
NovaMind will notify Customer without undue delay after confirming a Personal Data Breach affecting Customer Data. Notice will be sent to Customer's designated security or privacy contact.
...
- likely consequences identified by NovaMind;
...
Customer determines whether it must notify a supervisory authority, Data Subject, customer, insurer, or other party. NovaMind will provide reasonable assistance but does not make Customer's legal notification decision.

### 7.1.4 Investigation updates

NovaMind will provide material updates and a summary after containment when reasonably appropriate. Detailed forensic material may be restricted to protect security, privilege, confidentiality, or other customers.

### 7.1.5 Contact accuracy

Delay caused solely by Customer's failure to maintain a working notice contact does not breach the timing obligation if NovaMind used the current contact in its records.

### 7.1.6 Mitigation

Both parties will take reasonable steps within their control to mitigate harm and prevent recurrence.

*NM-DPA-EU-2026-04 · Page 13 of 34*
...
Taking account of the nature of Processing, NovaMind will provide reasonable assistance through available Service functionality and, where necessary, scoped technical support.

### 8.3 Direct requests

If NovaMind receives a request from a Data Subject that identifies Customer, NovaMind will direct the requester to Customer where reasonably possible and notify Customer unless prohibited. NovaMind will not independently respond on Customer's behalf without authorization or legal obligation.

### 8.4 Verification

Customer is responsible for verifying requester identity and authority. NovaMind may require Customer authentication before acting on an instruction.

### 8.5 Limitations

Assistance is subject to rights of others, security, confidentiality, legal holds, backup architecture, and data that NovaMind cannot reasonably associate with the requester based on information supplied.

### 8.6 Timing

Customer should submit assistance requests promptly and include case identifiers, data scope, requested action, and deadline. NovaMind does not warrant completion by a deadline that was not reasonably communicated.

### 8.7 Costs

Standard self-service functionality is included. Unusually complex assistance may be charged only after the parties agree scope and fees, unless the need results from NovaMind's breach.

*NM-DPA-EU-2026-04 · Page 14 of 34*
...
NovaMind will provide information reasonably available about the Service to assist Customer with a data-protection impact assessment or prior consultation that Applicable Data Protection Law requires.

### 8.1.2 Available materials

Assistance may include this DPA, security documentation, data-flow descriptions, subprocessor information, retention details, assurance reports, and written answers. NovaMind is not required to disclose source code, penetration-test details, information about other customers, or privileged material.
...
NovaMind may provide generally available notices of material Service or security changes. Customer is responsible for assessing whether a change affects its impact assessment.

### 8.1.6 No professional advice

NovaMind's materials describe the Service and do not constitute Customer-specific legal advice or regulatory approval. A technical control may reduce risk without resolving lawfulness or appropriateness.

### 8.1.7 Consultation support

If a supervisory authority requests Service-specific information, NovaMind will reasonably support Customer, subject to confidentiality and an agreed communication process.

*NM-DPA-EU-2026-04 · Page 15 of 34*
...
NovaMind will make available information reasonably necessary to demonstrate compliance with its Processor obligations under this DPA.
...
Audits must occur during business hours, minimize disruption, follow security requirements, protect other customers, and use an independent auditor that is not NovaMind's competitor. Scope must relate to Customer Data and obligations under this DPA.

### 8.2.5 Findings

The parties will discuss substantiated material findings and reasonable remediation. Audit reports are NovaMind Confidential Information unless law requires disclosure.

### 8.2.6 Costs

Customer bears its audit costs. NovaMind bears ordinary cooperation costs, but may charge pre-agreed fees for excessive scope unless the audit identifies NovaMind's material breach.
...
*NM-DPA-EU-2026-04 · Page 16 of 34*
...
NovaMind retains Customer Data during the Agreement term as necessary to provide the Service and according to Customer actions and configured retention settings.
...
NovaMind may retain limited data where law requires, provided it isolates the data from ordinary use and continues to protect it.
...
*NM-DPA-EU-2026-04 · Page 17 of 34*
...
Following termination or expiration, NovaMind will make Customer Data available for export for 30 days unless the order form states otherwise. Customer is responsible for completing export within that period.

### 8.4.3 Active-system deletion

After the retrieval period, NovaMind will delete Customer Data from active production systems within 45 days, except where retention is legally required.
...
On written request, NovaMind will provide a statement that deletion workflows have been initiated or completed, subject to backup and legal-retention exceptions.
...
Customer must remove integrations, tokens, downloaded exports, and local copies under its control. NovaMind's deletion does not delete copies Customer or its users created outside the Service.

*NM-DPA-EU-2026-04 · Page 18 of 34*
...
NovaMind maintains business-continuity and disaster-recovery procedures for material Service components. Procedures identify responsibilities, communication, backup, restoration, and dependency considerations.
...
NovaMind tests sample restoration at least quarterly and performs broader continuity exercises periodically. Material findings are tracked.

### 8.5.4 Dependencies

Recovery depends on cloud infrastructure, communications, identity services, model providers, and other Subprocessors. NovaMind evaluates material dependencies and maintains alternatives or recovery procedures according to risk.
...
During a major incident, NovaMind may prioritize containment and restoration over ordinary support requests or feature delivery.
...
*NM-DPA-EU-2026-04 · Page 19 of 34*
...
Customer gives NovaMind general written authorization to engage Subprocessors subject to this section. NovaMind remains responsible for each Subprocessor's performance of data-protection obligations to the extent required by Applicable Data Protection Law.

### 9.2 Selection

NovaMind evaluates a prospective Subprocessor's security, privacy, service capability, location, and relevant assurance before authorizing Processing of Customer Data.

### 9.3 Contract

NovaMind imposes written data-protection obligations that provide protection appropriate to the Processing and materially consistent with applicable Processor obligations in this DPA.

### 9.4 Scope limitation

A Subprocessor receives access only for defined services and according to documented arrangements. NovaMind restricts access according to role and technical need where feasible.

### 9.5 List

NovaMind maintains a current subprocessor list in its customer trust portal. The list identifies entity name, service purpose, and primary Processing country or region. Customer is responsible for maintaining an active trust-portal subscription if it wishes to receive portal updates.
...
*NM-DPA-EU-2026-04 · Page 20 of 34*
...
*NM-DPA-EU-2026-04 · Page 21 of 34*
...
Before granting access to Customer Data, NovaMind assesses a Subprocessor using information proportionate to service and data risk. Review may consider assurance reports, security questionnaires, architecture, incident history, transfer locations, financial resilience, and contractual protections.

### 9.2.2 Approval

A designated NovaMind owner approves the engagement. Material unresolved risks require documented treatment or acceptance.

### 9.2.3 Terms

Subprocessor terms address confidentiality, security, restricted purpose, incident notice, deletion or return, assistance, and transfer mechanisms as applicable. NovaMind may use a provider's standard terms when they meet legal and risk requirements.

### 9.2.4 Monitoring

NovaMind periodically reviews material Subprocessors. Frequency depends on service criticality, access, location, and available assurance.

### 9.2.5 Incident coordination

Subprocessor incident notices are escalated through NovaMind's incident process. NovaMind remains Customer's contractual contact and may combine information from multiple parties during investigation.

### 9.2.6 Termination

NovaMind may suspend or replace a Subprocessor that no longer provides appropriate protection. Migration timing may reflect security, continuity, technical feasibility, and contractual obligations.

### 9.2.7 Evidence limits

Customer may request reasonable information about a material Subprocessor, subject to confidentiality and provider restrictions. NovaMind is not required to disclose another provider's confidential audit report directly if a summary reasonably addresses the request.

*NM-DPA-EU-2026-04 · Page 22 of 34*
...
Notwithstanding any questionnaire response, trust-portal practice, or other general statement, Customer authorizes NovaMind to appoint, replace, or change a Subprocessor when NovaMind reasonably considers the change necessary for security, availability, capacity, support, legal compliance, or Service development.

### 9.6.2 No prior-notice obligation

**NovaMind may authorize a new or replacement Subprocessor to Process Customer Data, and may permit that Processing to occur outside the EEA, without providing Customer prior notice, provided that NovaMind updates its online subprocessor list within a commercially reasonable period and implements a transfer mechanism where Applicable Data Protection Law requires one.** Customer is deemed to have accepted the appointment when the updated list is published.
...
*NM-DPA-EU-2026-04 · Page 23 of 34*
...
Where NovaMind's Processing of Customer Data constitutes a Restricted Transfer, the parties will rely on an available lawful mechanism, including an adequacy decision or the SCCs as applicable.
...
NovaMind evaluates technical, contractual, and organizational supplemental measures appropriate to the transfer, including encryption, access control, request review, transparency, and data minimization.
...
If a relied-on mechanism becomes unavailable, the parties will cooperate to implement a valid alternative. NovaMind may suspend affected Processing if no lawful mechanism is reasonably available.
...
*NM-DPA-EU-2026-04 · Page 24 of 34*
...
NovaMind reviews a binding government request for Customer Data to determine validity, authority, scope, and whether challenge or narrowing is reasonably available.

### 10.1.2 Notice

NovaMind will notify Customer before disclosure unless legally prohibited. If prohibited, NovaMind may seek permission to notify where reasonably appropriate.

### 10.1.3 Minimization

NovaMind will disclose only data reasonably required by a valid request and will use available channels intended for lawful requests.

### 10.1.4 Challenge

NovaMind may challenge a request it reasonably believes is unlawful, overbroad, or inconsistent with applicable protections, taking account of legal advice and potential harm.

### 10.1.5 Transparency

Where legally permitted, NovaMind may publish aggregate transparency information. Aggregate reporting may omit categories where disclosure would create security or legal risk.

### 10.1.6 Emergency requests

NovaMind may respond to a good-faith emergency request involving imminent risk of death or serious physical harm where law permits, and will document the basis for the response.

### 10.1.7 Subprocessors

NovaMind contractually requires material Subprocessors to handle government requests according to applicable law and to notify NovaMind when permitted.

These measures reduce but cannot eliminate legal-access risk in every jurisdiction.

*NM-DPA-EU-2026-04 · Page 25 of 34*
...
NovaMind provides generated output for Customer review. The Service does not receive authority under this DPA to make final legal, employment, procurement, credit, medical, or similarly consequential decisions for Customer.

### 11.3 Shared-model training

NovaMind will not use Customer Content from an enterprise tenant to train a shared foundation model unless Customer gives separate express written authorization. Customer Content may be processed transiently by an authorized model Subprocessor to provide the requested output.
...
NovaMind may Process prompts, outputs, account signals, and limited Customer Content to detect abuse, investigate a Security Incident, enforce agreed restrictions, or comply with law, subject to access and retention controls.

### 11.6 Model changes

NovaMind may update models and routing to maintain or improve the Service. Material changes remain subject to the Agreement and applicable subprocessor terms; no fixed model version is promised unless the order form states one.
...
*NM-DPA-EU-2026-04 · Page 26 of 34*
...
NovaMind collects service telemetry such as request timing, error type, model route, token or processing-unit counts, feature use, security events, and system performance.
...
NovaMind may use aggregated or de-identified telemetry to improve reliability, capacity planning, interface design, abuse prevention, and operational models. It will not represent data as de-identified if re-identification remains reasonably likely.
...
Business contact, billing, and account-administration data may be processed by NovaMind as an independent Controller for contract administration, security, and legal obligations, as described in its privacy notice.

*NM-DPA-EU-2026-04 · Page 27 of 34*
...
The Service uses global cloud infrastructure and may Process Customer Data in the United States, European Union, and other locations where NovaMind or an authorized Subprocessor operates, subject to applicable transfer mechanisms.
...
Regional availability may change, but NovaMind will not knowingly reduce an executed customer-specific commitment without Customer agreement or a lawful emergency basis.

*NM-DPA-EU-2026-04 · Page 28 of 34*
...
*NM-DPA-EU-2026-04 · Page 29 of 34*
...
NovaMind may update its standard DPA for legal, security, or operational reasons. An update does not automatically replace this executed version unless the Agreement provides an update mechanism or the parties execute the change.
...
This DPA and incorporated documents state the parties' agreement about NovaMind's Processing of Customer Data. A questionnaire response is evidence for review but is not a contractual amendment unless expressly incorporated.

*NM-DPA-EU-2026-04 · Page 30 of 34*
...
This DPA begins on the Effective Date and continues while NovaMind Processes Customer Data under the Agreement.

### 15.2 Survival

Confidentiality, security, deletion, transfer, audit, and other provisions that by nature apply after termination survive while NovaMind retains Customer Data.

### 15.3 Suspension

NovaMind may suspend affected Processing to address a material security risk, unlawful instruction, non-payment, prohibited use, or absence of a lawful transfer mechanism. Where practicable, NovaMind will provide notice and an opportunity to cure.
...
*NM-DPA-EU-2026-04 · Page 31 of 34*
...
**Processor:** NovaMind AI Ltd., fictional AI SaaS provider. Contact role: Privacy Office.

### B. Subject matter

Provision, security, support, and maintenance of NovaMind Workspace Enterprise for document drafting, analysis, internal research, and configured workflows.
...
As described in sections 17 and 18, subject to Customer configuration and legal requirements.

### J. Competent authority

Determined under Applicable Data Protection Law and any SCC module.

*NM-DPA-EU-2026-04 · Page 32 of 34*

<div style="page-break-after: always;"></div>

## Page 33 of 34 — Annex II: Technical and organizational measures

NovaMind's measures include, according to risk and system applicability:
...
*NM-DPA-EU-2026-04 · Page 33 of 34*
...
| Field | Value |
|---|---|
| Agreement reference | NM-MSA-CW-2026-07 |
| DPA reference | NM-DPA-EU-2026-04 |
| DPA version | 4.3 |
| Effective date | 2026-07-12 |
...
*NM-DPA-EU-2026-04 · Page 34 of 34*
