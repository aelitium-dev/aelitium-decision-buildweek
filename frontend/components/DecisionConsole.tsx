          ...
          <article className="panel assessment-summary">
            ...
            <div className="evidence-note">
              ...
              <p>
                ...
                This screen uses a deterministic derivation of the checked-in T2 fixture. No GPT request runs in DEMO; the separate LIVE artifact was generated by GPT-5.6.
              </p>
            </div>
